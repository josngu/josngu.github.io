...
export function showSpells() {
    ...
    if (game.gameState.hasUsedSpell === true) disableSpells();
}
...
export function showSidebar() {
    ...
    let sidebarBGColor = game.getCurrentPlayer().darkenedRGBColor as [number, number, number];
...
export function showSpellName(spellName: string, duration?: number) {
    let color = game.getCurrentPlayer().darkenedRGBColor as [number, number, number];
