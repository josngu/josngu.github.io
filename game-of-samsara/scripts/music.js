...
export function playMusic() {
    ...
    Promise.all([musicCalmReady, musicRageReady]).then(() => {
        document.getElementById('music-calm').currentTime = currentlyPlayingMusic.calmOffset;
        document.getElementById('music-rage').currentTime = currentlyPlayingMusic.rageOffset;
        document.getElementById('music-calm').play();
        document.getElementById('music-rage').play();
    });
}
